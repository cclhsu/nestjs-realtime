// Path: src/models/common/task.dto.ts
// DESC: common task dto
'use strict';
...
//   sender: string; // Sender of the task
//   recipient: string; // Intended recipient (relevant for unicast tasks)
//   // recipients: string[]; // Intended recipients (relevant for broadcast tasks)
//   recipientType: RECIPIENT_TYPES; // Type of recipient (relevant for unicast tasks)
//   timestamp?: Date; // Timestamp when the task was sent (optional but useful)
// }

// // Task interface
// interface TaskInterface extends BaseInterface {
//   data: string | Record<string, any>; // Task data
...
export class TaskDTO {
  ...
  @ApiProperty({
    description: 'The sender of the task',
    example: 'e.g. user',
  })
  ...
  @ApiProperty({
    description: 'The recipient of the task',
    example: 'e.g. user',
  })
  ...
  @ApiProperty({
    description: 'The recipients of the task',
    example: 'e.g. user',
  })
  ...
  @ApiProperty({
    description: 'The recipient type of the task',
    example: 'e.g. user',
  })
  ...
  @ApiProperty({
    description: 'The timestamp of the task',
