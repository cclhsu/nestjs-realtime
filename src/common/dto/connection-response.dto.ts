...
//   status: string; // Status of the connection (success, failure)
//   code: number; // Status code for the connection
//   message: string; // Message for the connection
//   data: ConnectionInterface; // Data for the connection
// }
...
export class ConnectionResponseDTO {
  ...
  @ApiProperty({
    ...
    example: 'e.g. Connection successful',
  })
