...
import { WebRTCClientServiceModule } from './webrtc-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebRTCClientServiceModule, {
