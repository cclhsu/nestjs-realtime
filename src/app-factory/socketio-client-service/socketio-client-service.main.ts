// Path: src/app-factory/socketio/socketio.main.ts
// DESC: This is the main entry point for the socketio application.
'use strict';
...
import { SocketIOClientServiceModule } from './socketio-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(SocketIOClientServiceModule, {
