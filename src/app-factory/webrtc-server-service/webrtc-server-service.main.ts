// Path: src/app-factory/webrtc/webrtc.main.ts
// DESC: This is the main entry point for the webrtc application.
'use strict';
...
import { WebRTCServerServiceModule } from './webrtc-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebRTCServerServiceModule, {
