// Path: src/app-factory/redis/redis.main.ts
// DESC: This is the main entry point for the redis application.
'use strict';
...
import { RedisClientServiceModule } from './redis-consumer-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(RedisClientServiceModule, {
