...
import { ServerSentEventServerServiceModule } from './server-sent-event-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(ServerSentEventServerServiceModule, {
...
//   //     'InstanceToPlainTransformInterceptor',
//   //     ServerSentEventServerServiceModule,
//   //   );
