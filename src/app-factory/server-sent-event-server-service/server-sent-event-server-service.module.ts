...
import { ServerSentEventServerModule } from '../../server-sent-event/factory/server-sent-event-server/server-sent-event-server.module';
...
export class ServerSentEventServerServiceModule implements NestModule {
