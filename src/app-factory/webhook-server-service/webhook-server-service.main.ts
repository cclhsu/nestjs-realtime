// Path: src/app-factory/webhook/webhook.main.ts
...
import { WebhookServerServiceModule } from './webhook-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebhookServerServiceModule, {
