...
import { GrpcServerServiceModule } from './grpc-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(GrpcServerServiceModule, {
