// Path: src/app-factory/graphql/graphql.main.ts
...
import { GraphQLServerServiceModule } from './graphql-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(GraphQLServerServiceModule, {
