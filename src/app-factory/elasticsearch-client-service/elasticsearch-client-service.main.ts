// Path: src/app-factory/elasticsearch/elasticsearch.main.ts
// DESC: This is the main entry point for the elasticsearch application.
'use strict';
...
import { ElasticsearchClientServiceModule } from './elasticsearch-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(ElasticsearchClientServiceModule, {
...
//   //     'InstanceToPlainTransformInterceptor',
//   //     ElasticsearchClientServiceModule,
//   //   );
