...
import { WebpushServerServiceModule } from './webpush-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebpushServerServiceModule, {
