// Path: src/app-factory/websocket/websocket.main.ts
// DESC: This is the main entry point for the websocket application.
'use strict';
...
import { WebsocketClientServiceModule } from './websocket-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebsocketClientServiceModule, {
