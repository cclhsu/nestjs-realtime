// Path: src/app-factory/kafka/kafka.main.ts
// DESC: This is the main entry point for the kafka application.
'use strict';
...
import { KafkaServerServiceModule } from './kafka-producer-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(KafkaServerServiceModule, {
