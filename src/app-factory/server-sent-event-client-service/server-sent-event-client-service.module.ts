// Path: src/app-factory/server-sent-event/serversentevent.module.ts
...
import { ServerSentEventClientModule } from '../../server-sent-event/factory/server-sent-event-client/server-sent-event-client.module';
...
export class ServerSentEventClientServiceModule implements NestModule {
