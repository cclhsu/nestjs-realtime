// Path: src/app-factory/server-sent-event/serversentevent.main.ts
// DESC: This is the main entry point for the serversentevent application.
'use strict';
...
import { ServerSentEventClientServiceModule } from './server-sent-event-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(ServerSentEventClientServiceModule, {
//     httpsOptions: isHttps ? getHttpsOptions(configService) : undefined,
//     logger: LOG_LEVEL,
//   });

//   const configService: ConfigService = app.get(ConfigService);
//   const host = configService.get<string>('SERVICE_HOST') || '0.0.0.0';
...
//   //     'InstanceToPlainTransformInterceptor',
//   //     ServerSentEventClientServiceModule,
//   //   );
...
async function createServer(
  ...
  await setupSwagger(
    app,
    configService.get<string>('SERVICE_HOST') || '0.0.0.0',
...
function getConfiguredServerOptions(
  ...
  return {
    host: configService.get<string>(hostKey) || '0.0.0.0',
