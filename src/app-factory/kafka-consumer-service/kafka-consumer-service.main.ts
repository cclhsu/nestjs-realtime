...
import { KafkaClientServiceModule } from './kafka-consumer-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(KafkaClientServiceModule, {
