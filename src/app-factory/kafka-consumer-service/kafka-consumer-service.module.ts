// Path: src/app-factory/kafka/kafka.module.ts
...
import { KafkaClientModule } from '../../kafka/factory/kafka-client/kafka-client.module';
...
export class KafkaClientServiceModule implements NestModule {
