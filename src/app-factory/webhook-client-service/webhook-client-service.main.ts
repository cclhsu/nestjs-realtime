...
import { WebhookClientServiceModule } from './webhook-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebhookClientServiceModule, {
