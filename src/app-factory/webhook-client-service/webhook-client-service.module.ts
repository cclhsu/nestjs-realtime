// Path: src/app-factory/webhook/webhook.module.ts
...
import { WebhookClientModule } from '../../webhook/factory/webhook-client/webhook-client.module';
...
export class WebhookClientServiceModule implements NestModule {
