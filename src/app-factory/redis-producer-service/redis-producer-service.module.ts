// Path: src/app-factory/redis/redis.module.ts
...
import { RedisServerModule } from '../../redis/factory/redis-server/redis-server.module';
...
export class RedisServerServiceModule implements NestModule {
