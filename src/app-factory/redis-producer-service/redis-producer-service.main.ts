...
import { RedisServerServiceModule } from './redis-producer-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(RedisServerServiceModule, {
