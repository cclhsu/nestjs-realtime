...
import { GraphQLClientServiceModule } from './graphql-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(GraphQLClientServiceModule, {
