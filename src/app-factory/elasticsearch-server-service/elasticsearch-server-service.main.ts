...
import { ElasticsearchServerServiceModule } from './elasticsearch-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(ElasticsearchServerServiceModule, {
...
//   //     'InstanceToPlainTransformInterceptor',
//   //     ElasticsearchServerServiceModule,
//   //   );
