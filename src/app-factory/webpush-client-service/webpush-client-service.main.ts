// Path: src/app-factory/webpush/webpush.main.ts
// DESC: This is the main entry point for the webpush application.
'use strict';
...
import { WebpushClientServiceModule } from './webpush-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebpushClientServiceModule, {
