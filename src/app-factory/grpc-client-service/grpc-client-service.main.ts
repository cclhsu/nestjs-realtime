// Path: src/app-factory/grpc/grpc.main.ts
...
import { GrpcClientServiceModule } from './grpc-client-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(GrpcClientServiceModule, {
