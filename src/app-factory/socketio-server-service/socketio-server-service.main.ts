...
import { SocketIOServerServiceModule } from './socketio-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(SocketIOServerServiceModule, {
