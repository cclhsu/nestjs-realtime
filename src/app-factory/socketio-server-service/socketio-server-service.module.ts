...
import { SocketIOServerModule } from '../../socketio/factory/socketio-server/socketio-server.module';
...
export class SocketIOServerServiceModule implements NestModule {
