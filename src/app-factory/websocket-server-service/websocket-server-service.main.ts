...
import { WebsocketServerServiceModule } from './websocket-server-service.module';
...
//   const app: INestApplication<any> = await NestFactory.create(WebsocketServerServiceModule, {
