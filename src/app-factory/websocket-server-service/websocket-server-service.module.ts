...
import { WebsocketServerModule } from '../../websocket/factory/websocket-server/websocket-server.module';
...
export class WebsocketServerServiceModule implements NestModule {
