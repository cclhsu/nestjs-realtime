...
import { ServerSentEventClientInterface } from './server-sent-event-client.interface';

@Injectable()
export class ServerSentEventClientService implements ServerSentEventClientInterface {
